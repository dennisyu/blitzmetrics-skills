...
The canonical marketplace for the 29 BlitzMetrics and Local Service Spotlight
...
|---|---|
| `blitzmetrics-everything` | All 29 skills |
...
29 `SKILL.md` files, so the rules arrive with the pack even though `standards/`
